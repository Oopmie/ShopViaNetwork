    ...
    Column(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(15.dp)) {
            Text("Без профиля вы не сможете создавать проекты.",
                style = Caption.bodySmall, color = CaptionColor)
        ...
        Column(verticalArrangement = Arrangement.SpaceBetween, modifier = Modifier
            ...
            AppTextField(value = secondName, onValueChange = {
                ...
                isError = secondNameError, placeholder = "Отчество",
            ...
            AppTextField(value = birthday, onValueChange = {
                ...
                isError = birthdayError, placeholder = "Дата рождения",
            ...
            Button(modifier = Modifier.fillMaxWidth().padding(top = 30.dp).height(56.dp),
                onClick = { viewModel.name = name
